    ...
    return (
        <Card isFullHeight>
            ...
            <CardBody>
                ...
                <Content component={ContentVariants.p} className="pf-v6-u-mb-sm">
                    {t('Learn how to')}{' '}
                    <a target="_blank" href={DOC_LINKS.TERRAFORM_ROSA_HCP_URL}>{t('deploy a ROSA HCP cluster')}</a>{' '}
                    {t('or')}{' '}
                    <a target="_blank" href={DOC_LINKS.TERRAFORM_REGISTRY_ROSA_HCP}>{t('visit the Terraform registry')}</a>
                </Content>
            </CardBody>
        </Card>
    )
